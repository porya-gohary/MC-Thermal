...
public abstract class Vertex implements Comparable<Vertex>, Cloneable, Serializable {
    ...
    public int compareTo(Vertex obj) {
        ...
        if (Arrays.asList(stackTraceElements).toString().contains("Salehi")) {
//            System.out.println("..........SALEHI..........");
    ...
    public int getTSP_Active() {
        return TSP_Active;
    }

    public void setTSP_Active(int TSP_Active) {
        this.TSP_Active = TSP_Active;
    }
...
//        System.out.println("<<<<<<<<------>>>>>>>>");
    ...
    public void setWCET_LO(int WCET) {
        this.wcets[0] = WCET;
    }

    public void setWCET_HI(int WCET) {
        this.wcets[1] = WCET;
    }
    ...
    public void setOpt(int optVar, int i) {
        this.optVar[i] = optVar;
    }
