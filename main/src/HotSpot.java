...
public class HotSpot {
    ...
    String floorplan = " -f ";
    String powertrace = " -p ";
    String steady_file = " -steady_file A15.steady";
...
//            if (!VERBOSE)System.out.println();
    ...
    //    ./hotspot -c hotspot3.config -f ~/Desktop/Cortex_A15_9.flp -p ~/Desktop/A15_Trace_9.ptrace -steady_file A15.steady -model_type block

    public void run_steady(String hotspot_config, String floorplan, String powertrace){
        this.hotspot_config = " -c ";
        this.floorplan = " -f ";
        this.powertrace = " -p ";
        this.steady_file = " -steady_file A15.steady";
        this.model_type = " -model_type block";
        this.hotspot_config += hotspot_config;
        this.floorplan += floorplan;
        this.powertrace += powertrace;

        Process process =null;
        String command = hotspot_path + this.hotspot_config + this.floorplan + this.powertrace + steady_file + model_type ;
        if (VERBOSE)System.out.println(command);
        Runtime runtime = null;
        try {
            Instant start = Instant.now();
